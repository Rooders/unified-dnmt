...
class TransformerEncoderLayer(nn.Module):
  ...
  def forward(self, inputs=None, mask=None, doc_num=None, trans_inputs=None, trans_mask=None):
    ...
    if self.doc_ctx_start and self.cross_attn:
      ...
      (trans_attn_type, src_attn_type) = ("share", "share") if self.share_enc_cross_attn \
                                                                  else ("auto2src", "src2auto")
      trans_inputs = do_cross_attn(inputs, trans_inputs, mask, attn_type=src_attn_type)
