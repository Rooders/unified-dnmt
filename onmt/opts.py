...
def preprocess_opts(parser):
  ...
  group.add('--train_auto_trans', '-train_auto_trans', type=str, default="",
            help="Path to the auto translation data")
  ...
  group.add('--valid_auto_trans', '-valid_auto_trans', type=str, default="",
            help="Path to the auto translation data")

  group.add('--sentence_level', '-sentence_level', type=int, default=0,
            help="Path to the valid source link mask data")

  group.add('--pre_paired_trans', '-pre_paired_trans', type=int, default=0,
            help="Paired sentence translation type of data")
  
  group.add('--use_auto_trans', '-use_auto_trans', type=int, default=0,
            help="use automatic translation type of data")
...
def train_opts(parser):
    ...
    group.add('--sentence_level', '-sentence_level', type=bool, default=False,
              help="""Path prefix to the ".train.pt" and
                           ".valid.pt" file path from preprocess.py""")
    ...
    group.add('--mixed_precision', '-mixed_precision', action='store_true',
              help="""use the mixed precision or not""")
    group.add('--use_ord_ctx', '-use_ord_ctx',type=int, default=0,
              help="""use the mixed precision or not""")
    
    group.add('--paired_trans', '-paired_trans',type=int, default=0,
              help="""apply for the paired translation or not""")
    
    group.add('--use_auto_trans', '-use_auto_trans', type=int, default=0,
            help="use the automatic translation to improve the performance of transltion")
    
    group.add('--gated_auto_src', '-gated_auto_src', type=int, default=0,
            help="use the automatic translation to improve the performance of transltion")
    
    group.add('--share_enc_cross_attn', '-share_enc_cross_attn', type=int, default=1,
            help="use the automatic translation to improve the performance of transltion")
    
    group.add('--share_dec_cross_attn', '-share_dec_cross_attn', type=int, default=1,
            help="use the automatic translation to improve the performance of transltion")

    group.add('--init_cross_sent', '-init_cross_sent', type=int, default=0,
            help="use the automatic translation to improve the performance of transltion")
    
    group.add('--src_mlm', '-src_mlm', type=int, default=0,
            help="use the MASK LNAGUAGE MDOEL for source encoding")
    ...
    group.add('--cross_attn', '-cross_attn', type=int, default=0,
            help="use the automatic translation to improve the performance of transltion")
    
    group.add('--decoder_cross_before', '-decoder_cross_before', type=int, default=0,
            help="use the automatic translation to improve the performance of transltion")
    
    group.add('--cross_before', '-cross_before', type=int, default=0,
            help="use the automatic translation to improve the performance of transltion")
    
    group.add('--only_fixed', '-only_fixed', type=int, default=0,
            help="use the automatic translation to improve the performance of transltion")

    group.add('--multi_task_training', '-multi_task_training', type=int, default=0,
            help="use the automatic translation to improve the performance of transltion")
    
    group.add('--shift_num', '-shift_num', type=int, default=0,
            help="paird the X-th automatic trans with the current source sentence")
    ...
    group.add('--valid_batch_size', '-valid_batch_size', type=int, default=1,
    ...
    group.add('--decay_method', '-decay_method', type=str, default="none",
              choices=['noam', 'inverse_sqrt', 'none'], help="Use a custom decay rate.")
    ...
    group.add('--doc_double_lr', '-doc_double_lr', type=int, default=0,
                       help="pretrained parameter and initlized parameter use different learning rate")

    group.add('--doc_lr', '-doc_lr', type=float, default=1.0,
                       help="initlized parameter how times the pretrained parameter")
